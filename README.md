...
Ask questions like "Get messages from #social" or "Find emails from John" and the AI figures out what to do. Now powered by **gpt-5-nano** (November 2025) - lightweight reasoning model with tool calling and streaming.
